...
class BlacklistTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @return void
     */
    public function itReturns403ForListedIpAddresses($clientIp, array $ipAddresses)
    {
        $stackedApp = new Blacklist($this->kernel, $ipAddresses);
    ...
    /**
     * Test: It Returns 200 for Non-listed IP Addresses
     *
     * @test
     ...
     * @return void
     */
    public function itReturns200ForNonListedIpAddresses($clientIp, array $ipAddresses)
    {
        $stackedApp = new Blacklist($this->kernel, $ipAddresses);
        $request = m::mock('Symfony\Component\HttpFoundation\Request', function ($mock) use ($clientIp) {
            $mock->shouldReceive('getClientIp')->once()->andReturn($clientIp);
     ...
     * @return void
     */
    public function itReturns200WhenInvalidIpAddressesAreListed()
    {
        $stackedApp = new Blacklist($this->kernel, array('list', 'of', 'invalid', 'ip', 'addresses'));
    ...
    /**
     * Test: It Returns A Custom Response When Set and IP Addresses Match
     *
     * @test
     * @access public
     * @return void
     */
    public function itReturnsACustomResponseWhenSetAndIpAddressesMatch()
    {
        $statusCode = 402;
        ...
        $stackedApp = new Blacklist($this->kernel, array('12.34.56.78'));
